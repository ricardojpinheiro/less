...
40 E=E+1
50 GOTO 20
60 LOCATE 0,20: PRINT"Essa linha se mexe!"
65 PRINT "TECLE ALGO ..."
70 LOCATE 0,23 : PRINT"Esta linha nao se mexe."
80 locate 0, 3: A$=INPUT$(1)
90 DEFUSR=&HC000 
95 for a = 1 to 15 : X=USR(0) : next a
100 DATA 21,50,00 : ' LD HL,&H0050 <- Linha 2 na VRAM (em 80 colunas).
...
150 DATA 11,00,00 : ' LD DE,&H0000 <- Linha 1 na VRAM (em 80 colunas).
