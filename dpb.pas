...
(**
  *
  * $Id: dpb.pas 98 2015-08-21 01:28:40Z popolony2k $
  * $Author: popolony2k $
...
(**
  ...
  * @param Drive The disk drive to retrieve DPB ( A - 0, B - 1, ...);
  * @param DPB The DPB retrieved;
  * The function return:
  * ctError - Operation failed;
  * ctOk - Operation success;
  * WARNING: Before use this function, call any disk MSXDOS/BDOS function,
  * like the Search First BDOS function (SearF), to update the DPB in memory.
  *)
...
(**
  * Get the sector buffer address.
  *)
Function GetSectorBufferAddress : Integer;
Var
   nSectorRAMAddr : Integer;

Begin
  nSectorRAMAddr := ctSectorAddress;
  GetSectorBufferAddress := GetInteger( nSectorRAMAddr );
End;
