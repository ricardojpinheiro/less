...
(**
  *
  * $Id: dumphelp.pas 98 2015-08-21 01:28:40Z popolony2k $
  * $Author: popolony2k $
...
(**
  ...
  *)
Procedure SaveAppTextMode( Var scrHandle  : TOutputHandle;
                           Var scrStat,
...
(**
  ...
  *)
Procedure RestoreAppTextMode( Var scrHandle  : TOutputHandle;
                              Var scrStat,
                                  oldScrStat : TScreenStatus );
Begin
